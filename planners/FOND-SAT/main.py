...
args_parser.add_argument('-strong', type = int, default = 0, help = '1: strong planners mode; 0: default, strong cyclic planners mode')
...
p.set_domain(str(Path(params['path_domain']).resolve()))
p.set_problem(str(Path(params['path_instance']).resolve()))
...
for i in range(1000):
	...
	command = f'{FONDSAT_DIR}/minisat {name_formula_file} {name_output_satsolver}'
